(function() {
  ...
  exports.createBuildDirectories = function(buildPath, directories) {
    ...
    if (directories == null) directories = ['web/css', 'web/js'];
    _results = [];
  ...
  exports.filterFiles = function(files, sourcePath) {
    return files.filter(function(filename) {
      var stats;
      if (exports.Watcher.prototype.invalid.test(filename)) return false;
      stats = fs.statSync(path.join(sourcePath, filename));
      if (stats != null ? stats.isDirectory() : void 0) return false;
      return true;
    });
  };
  ...
  exports.log = function(text, color, isError) {
    ...
    if (isError) return exports.notify('Brunch error', text);
  };
